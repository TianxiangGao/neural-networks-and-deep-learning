...
def omit_FC():
    for j in range(3):
        ...
        net.stochastic_gradient_descent(training_data, 60, mini_batch_size, 0.1, validation_data, test_data)
    return net 
    ...
    for lmbda in [0.00001, 0.0001, 0.001, 0.01, 0.1, 1.0, 10.0, 100.0]:
        for j in range(3):
            ...
            net = Network([
                ...
                SoftmaxLayer(n_in=100, n_out=10)], mini_batch_size)
            net.stochastic_gradient_descent(training_data, 60, mini_batch_size, 0.1, validation_data, test_data, lmbda=lmbda)
    ...
    for lmbda in [0.0, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1.0, 10.0, 100.0]:
        for j in range(3):
            ...
            net = Network([
                ...
                SoftmaxLayer(n_in=100, n_out=10)], mini_batch_size)
            net.stochastic_gradient_descent(training_data, 60, mini_batch_size, 0.03, validation_data, test_data, lmbda=lmbda)
...
def expanded_data(n=100):
    ...
    for j in range(3):
        ...
        net.stochastic_gradient_descent(expanded_training_data, 60, mini_batch_size, 0.03,
...
def double_fc_dropout(p0, p1, p2, repetitions):
    ...
    for j in range(repetitions):
        ...
        net.stochastic_gradient_descent(expanded_training_data, 40, mini_batch_size, 0.03,
                                        validation_data, test_data)
        nets.append(net)
    return nets
