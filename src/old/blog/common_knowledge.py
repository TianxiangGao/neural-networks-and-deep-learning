...
ae_1.stochastic_gradient_descent(td_1, 4, 10, 0.01, 0.05)

print "\nFinding second autoencoder"
ae_2 = Network([784, HIDDEN, 784])
ae_2.stochastic_gradient_descent(td_1, 4, 10, 0.01, 0.05)
...
net.stochastic_gradient_descent(encoded_training_data, 6, 10, 0.01, 0.05)
