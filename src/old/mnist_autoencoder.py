...
def train_autoencoder(hidden_units, training_data):
    ...
    net.stochastic_gradient_descent(autoencoder_training_data, 6, 10, 0.01, 0.05)
    return net
...
def classifier(hidden_units, n_unlabeled_inputs, n_labeled_inputs):
    ...
    net_c.stochastic_gradient_descent(training_data[-n_labeled_inputs:], 300, 10, 0.01, 0.05)
    ...
    net.stochastic_gradient_descent(training_data[-n_labeled_inputs:], 300, 10, 0.01, 0.05)
    print "Result on test data: %s / %s" % (
